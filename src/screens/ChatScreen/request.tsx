                  ...
                  {items.map((item) => (
                    <div  key={item.id}  className="mb-2 flex">
                      ...
                      <p className="ml-3">
                        ...
                        <div className="flex text-sm"><div className="font-medium">4+ New Messages</div><div className="ml-2 font-roboto">-12 min</div> <img src={item.pic} className="ml-5 cursor-pointer" /></div>
                        <div className="text-xs font-medium">14 Followers</div>
                      </p>
                    </div>
                  ))}
                </div>
                <div className="flex mt-55">
                <div>
